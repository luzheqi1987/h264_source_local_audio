...
static inline void circlebuf_init(struct jerky_circlebuf *cb)
{
	memset(cb, 0, sizeof(struct jerky_circlebuf));
}

static inline void circlebuf_free(struct jerky_circlebuf *cb)
{
	bfree(cb->data);
	memset(cb, 0, sizeof(struct jerky_circlebuf));
}

static inline void circlebuf_reorder_data(struct jerky_circlebuf *cb,
		size_t new_capacity)
{
	size_t difference;
	uint8_t *data;
...
static inline void circlebuf_ensure_capacity(struct jerky_circlebuf *cb)
{
	size_t new_capacity;
...
static inline void circlebuf_reserve(struct jerky_circlebuf *cb, size_t capacity)
{
...
static inline void circlebuf_upsize(struct jerky_circlebuf *cb, size_t size)
{
...
static inline void circlebuf_place(struct jerky_circlebuf *cb, size_t position,
...
static inline void circlebuf_push_back(struct jerky_circlebuf *cb, const void *data,
		size_t size)
{
...
static inline void circlebuf_push_front(struct jerky_circlebuf *cb, const void *data,
		size_t size)
{
	cb->size += size;
	circlebuf_ensure_capacity(cb);
...
static inline void circlebuf_peek_front(struct jerky_circlebuf *cb, void *data,
		size_t size)
{
	assert(size <= cb->size);
...
static inline void circlebuf_peek_back(struct jerky_circlebuf *cb, void *data,
		size_t size)
{
	assert(size <= cb->size);
...
static inline void circlebuf_pop_front(struct jerky_circlebuf *cb, void *data,
		size_t size)
{
...
static inline void circlebuf_pop_back(struct jerky_circlebuf *cb, void *data,
		size_t size)
{
	circlebuf_peek_front(cb, data, size);
